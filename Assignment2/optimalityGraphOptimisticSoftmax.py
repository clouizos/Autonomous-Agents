...
f = open('optimalityQ_1.0E-5_0.2_0.1softmaxOptimistic.data', 'r')
f2 = open('optimalityQ_1.0E-4_0.2_0.1softmaxOptimistic.data', 'r')
f3 = open('optimalityQ_0.001_0.2_0.1softmaxOptimistic.data', 'r')
#f2 = open('optimalityQ_0.1_0.2_0.1init5.data', 'r')
#f3 = open('optimalityQ_0.1_0.2_0.1init10.data', 'r')
#f4 = open('optimalityQ_0.1_0.2_0.1init15.data', 'r')
f5 = open('optimalityQ_0.1_0.2_0.1initVI.data', 'r')
...
#print data
plt.figure(1)
plt.plot(ddata, 'r', label = '1x10^-5')
plt.ylim([0,1])
plt.ylabel('optimality')
plt.xlabel('iterations x 100')
plt.legend(loc=4)
#plt.figure(2)
plt.plot(ddata2, 'b', label = '1x10^-4')
plt.legend(loc=4)
##plt.figure(3)
