...
f = open('convergenceQLearning_0.001_0.2_0.9.data', 'r')
f2 = open('convergenceQLearning_0.1_0.2_0.9.data', 'r')
f3 = open('convergenceQLearning_0.2_0.2_0.9.data', 'r')
f4 = open('convergenceQLearning_0.3_0.2_0.9.data', 'r')
f5 = open('convergenceQLearning_0.5_0.2_0.9.data', 'r')
...
#print data
plt.figure(1)
plt.plot(data, 'r', label = '0.001')
plt.ylim([0,40])
plt.ylabel('episode size')
plt.xlabel('iterations')
plt.legend()
plt.figure(2)
plt.plot(data2, 'b', label = '0.1')
plt.ylim([0,40])
plt.ylabel('episode size')
plt.xlabel('iterations')
plt.legend()
plt.figure(3)
plt.plot(data3, 'g', label = '0.2')
plt.ylim([0,40])
plt.ylabel('episode size')
plt.xlabel('iterations')
plt.legend()
plt.figure(4)
plt.plot(data4, 'm', label = '0.3')
plt.ylim([0,40])
plt.ylabel('episode size')
plt.xlabel('iterations')
plt.legend()
