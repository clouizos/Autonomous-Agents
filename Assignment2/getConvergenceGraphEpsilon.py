...
f = open('convQLearning_0.001_0.2_0.1.data', 'r')
f2 = open('convQLearning_0.1_0.2_0.1.data', 'r')
f3 = open('convQLearning_0.2_0.2_0.1.data', 'r')
f4 = open('convQLearning_0.3_0.2_0.1.data', 'r')
f5 = open('convQLearning_0.5_0.2_0.1.data', 'r')
...
#print data
plt.figure(1)
plt.plot(ddata[80:100], 'r', label = '0.001')
plt.ylim([3,25])
plt.ylabel('episode size')
plt.xlabel('last 20 iterations x 100')
plt.legend(loc=2)
#plt.figure(2)
plt.plot(ddata2[80:100], 'b', label = '0.1')
plt.legend()
#plt.figure(3)
plt.plot(ddata3[80:100], 'g', label = '0.2')
plt.legend(loc=2)
#plt.figure(4)
plt.plot(ddata4[80:100], 'm', label = '0.3')
plt.legend(loc=2)
#plt.figure(5)
...
plt.figure(6)
plt.plot(ddata, 'r', label = '0.001')
plt.ylim([0,100])
plt.ylabel('episode size')
plt.xlabel('iterations x 100')
plt.legend()
#plt.figure(2)
plt.plot(ddata2, 'b', label = '0.1')
plt.legend()
#plt.figure(3)
plt.plot(ddata3, 'g', label = '0.2')
plt.legend()
#plt.figure(4)
plt.plot(ddata4, 'm', label = '0.3')
plt.legend()
#plt.figure(5)
...
plt.figure(7)
plt.plot(ddata[0:20], 'r', label = '0.001')
plt.ylim([0,150])
plt.ylabel('episode size')
plt.xlabel('first 20 iterations x 100')
plt.legend()
#plt.figure(2)
plt.plot(ddata2[0:20], 'b', label = '0.1')
plt.legend()
#plt.figure(3)
plt.plot(ddata3[0:20], 'g', label = '0.2')
plt.legend()
#plt.figure(4)
plt.plot(ddata4[0:20], 'm', label = '0.3')
plt.legend()
#plt.figure(5)
