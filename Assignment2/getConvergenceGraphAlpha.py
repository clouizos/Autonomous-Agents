...
f = open('convQLearning_0.1_0.1_0.9.data', 'r')
f2 = open('convQLearning_0.1_0.2_0.9.data', 'r')
f3 = open('convQLearning_0.1_0.3_0.9.data', 'r')
f4 = open('convQLearning_0.1_0.4_0.9.data', 'r')
...
plt.legend()
#plt.figure(3)
plt.plot(ddata3[80:100], 'g', label = '0.3')
plt.legend()
#plt.figure(4)
plt.plot(ddata4[80:100], 'm', label = '0.4')
plt.legend()
#plt.figure(5)
...
plt.legend()
#plt.figure(3)
plt.plot(ddata3[0:20], 'g', label = '0.3')
plt.legend()
#plt.figure(4)
plt.plot(ddata4[0:20], 'm', label = '0.4')
plt.legend()
#plt.figure(5)
