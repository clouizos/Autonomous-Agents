...
f = open('optimalityQ_0.1_0.2_0.1softmax.data', 'r')
f2 = open('optimalityQ_0.01_0.2_0.1softmax.data', 'r')
f3 = open('optimalityQ_0.001_0.2_0.1softmax.data', 'r')
f4 = open('optimalityQ_1.0E-4_0.2_0.1softmax.data', 'r')
f5 = open('optimalityQ_1.0E-5_0.2_0.1softmax.data', 'r')
f6 = open('optimalityQ_0.1_0.2_0.1egreedy.data', 'r')
